...
export default {
	...
	fight: {
		...
		"player attack damage": `You did <b class='color-good'>{{damage}}</b> damage`,
		...
		"enemy attack damage": `The enemy did you <b class='color-wrong'>{{damage}}</b> damage`,
		...
		"life steal": `You stole <b class='color-good'>{{lifeSteal}}</b> life from the enemy`,
		attacks: {
			normal: "normal",
			critic: "critic",
